...
export function memberReadiness(member: GroupMemberInput, terminals: {id: string}[], candidates: GroupCandidate[]): MemberReadiness;
export function groupReadiness(members: GroupMember[], terminals: {id: string}[], candidates: GroupCandidate[], targets: string[], author: string): {
